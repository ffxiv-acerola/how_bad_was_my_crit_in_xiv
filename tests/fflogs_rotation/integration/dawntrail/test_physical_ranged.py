...
data_path = Path("tests/fflogs_rotation/integration/dawntrail/physical_ranged_data/")
...
def test_physical_ranged_end_to_end(mock_action_table_api_via_file, mock_gql_query_integration, params):
    phase = params["phase"]
